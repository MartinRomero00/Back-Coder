import { getProductByIdService, getProductsService, addProductService, updateProductService, deleteProductService } from "../services/productService.js";

export const getProductsController = async (req, res, next) => {
    try {
        const { page, limit, ord} = req.query;
        const products = await getProductsService(page, limit, ord);
        let statusRes;
